...
def get_register_form() -> Dict[str, str | Any]:
    ...
    return submit_form(
        "S'enregistrer",
        [
            {"name": "admin_password", "description": "Mot de passe administrateur", "validator": password_validator},
            {"name": "email", "description": "Email", "validator": email_validator},
...
def get_id_form() -> Dict[str, str | Any]:
    """
        Retourne un formulaire pour trouver un identifiant
    """
    return submit_form(
...
def get_update_epic_client_form() -> Dict[str, str | Any]:
    ...
    return submit_form(
        ...
        [
            {"name": "updated_name", "description": "Nom", "validator": str_validator},
            {"name": "updated_email", "description": "Email", "validator": email_validator},
            {"name": "updated_phone", "description": "Numéro de télephone", "validator": phone_validator},
            {"name": "updated_entreprise", "description": "Entreprise", "validator": str_validator},
        ]
    )
...
def get_create_event_form() -> Dict[str, str | Any]:
    ...
    return submit_form(
        "Créer un évènement",
        [
            {"name": "contract_id", "description": "Contrat", "validator": int_validator},
...
def get_assign_support_event_form() -> Dict[str, str | Any]:
    """
        Retourne un formulaire pour créer un évènement
    """
    return submit_form(
